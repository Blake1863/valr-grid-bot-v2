...
export class PositionManager {
  ...
  updateFromWs(data: WsOpenPositionUpdate): void {
    ...
    this._position = {
      ...
      side: data.side,
      quantity: qty,
      averageEntryPrice: new Decimal(data.averageEntryPrice), // SOURCE OF TRUTH
    ...
    this._persist();
    log.info(
      { side: data.side, qty: data.quantity, avg: data.averageEntryPrice },
